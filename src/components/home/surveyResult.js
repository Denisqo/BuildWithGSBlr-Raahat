        ...
        <div className="columns ml-2">
          ...
          <div className="column">
            ...
            <div className="content">
              The app is automated to keep track of the people who are in need of food and ration kits by conducting a
              survey based on the number of people in a particular slum and the food items needed by them.
            </div>
            <div>
